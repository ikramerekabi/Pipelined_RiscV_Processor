...
HD_PWD='C:/Users/ikrame.rekabi/Documents/GitHub/Pipelined_RiscV_Processor/lab5_Maram_Ikrame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_Cycle_CPU.tcl -notrace
