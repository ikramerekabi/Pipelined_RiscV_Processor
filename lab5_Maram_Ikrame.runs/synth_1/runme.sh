...
HD_PWD='C:/Users/ikrame.rekabi/Documents/GitHub/Pipelined_RiscV_Processor/lab5_Maram_Ikrame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Single_Cycle_CPU.tcl
